 ...
 * CREATE CHALLAN
 */
router.post("/", authMiddleware, authorize(["ADMIN", "SALES"]), async (req: AuthRequest, res) => {
  try {
 ...
 */
router.put("/:id", authMiddleware, authorize(["ADMIN", "SALES", "WAREHOUSE"]), async (req: AuthRequest, res) => {
  try {
    const id = req.params.id as string;
 ...
 */
router.delete("/:id", authMiddleware, authorize(["ADMIN", "SALES"]), async (req: AuthRequest, res) => {
  try {
    const id = req.params.id as string;
